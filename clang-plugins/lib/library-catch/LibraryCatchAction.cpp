...
class ClassNameVisitor : public clang::RecursiveASTVisitor<ClassNameVisitor>
{
public:
  ClassNameVisitor(const std::vector<std::string> libraries) : bannedLibraries(libraries)
  {
  }
...
bool LibraryCatchAction::ParseArgs(const clang::CompilerInstance &ci,
...
void LibraryCatchAction::EndSourceFileAction()
{
